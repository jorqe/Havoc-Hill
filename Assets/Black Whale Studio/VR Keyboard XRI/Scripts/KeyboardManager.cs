...
namespace Keyboard
{
    public class KeyboardManager : MonoBehaviour
    {
        ...
        [SerializeField] private TextMeshPro quizText;
        ...
        private void Awake()
        {
            ...
            doneButton.onClick.AddListener(OnDonePress);
        ...
        private void OnEnterPress()
        {
            if (!quizTitle){
                ...
                quizTitle = true;
                flag++;
                Debug.Log("quizFileName = " + quizFileName);
            }
            else{
                if (flag == 0){
                    quizText.text = "Enter hint";
                    ...
                    quizText.text = "Enter answer";
                    flag = 0;
                }
                Debug.Log("in else statement");
                Debug.Log(Application.persistentDataPath);
                TextWriter tw = new StreamWriter(Application.persistentDataPath+quizFileName, true);
                tw.WriteLine(outputField.text);
                tw.Close();
            }
        ...
        private void OnDonePress()
        {
            ...
            dropdown.options.Add(new TMP_Dropdown.OptionData(quizFileName.Substring(1), null));
